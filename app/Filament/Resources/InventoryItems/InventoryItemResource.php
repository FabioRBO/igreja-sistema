...
class InventoryItemResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Item de Inventário';

    protected static ?string $pluralModelLabel = 'Itens de Inventário';

    protected static ?string $navigationLabel = 'Itens / Patrimônio';
